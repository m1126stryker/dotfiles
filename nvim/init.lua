...
vim.keymap.set({'n','v'}, '<leader>=', '>i{', { desc = 'indent the inner block one tab to the right' })
vim.keymap.set({'n','v'}, '<leader>+', '<i{', { desc = 'indent the inner block one tab to the left' })
